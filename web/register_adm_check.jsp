    ...
    <body>
        <%
            ...
            try {
                ...
                operation = String.format("insert into appdata.user_info(user_id, user_name, password, status, nickname, level) values('%s','%s','%s','T','%s',0);",n ,user_name, password, nickname);
