...
<head>
    ...
    <body>
        <div id="bigBox" style="height: auto">
            <h1 style="font-family:宋体,serif; ">企业用户注册</h1>
            <div class="inputBox" style="font-family: 宋体,serif;font-size: 18px">
                <form action="register_ent_check.jsp" method="post" id="form">
                    <div class="inputText">
                        <label>
                    ...
                    <div class="inputText">
                        <label>
                            ...
                            证件：<input type="text" placeholder="企业ID" id = "IdCard" name="IdCard"/>
                        </label>
                    </div>
                    <div class="inputText">
                        <label>
